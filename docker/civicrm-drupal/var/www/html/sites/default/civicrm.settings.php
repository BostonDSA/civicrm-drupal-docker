...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  ...
  define( 'CIVICRM_UF_DSN', "mysql://$mysql_user:$mysql_password@$mysql_host/$mysql_database?new_link=true");
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', "mysql://$mysql_user:$mysql_password@$mysql_host/$mysql_database?new_link=true");
  }
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'eb8e84515f403b35f6afe57b86d5ceda');
}
